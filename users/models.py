...
class UserProfile(models.Model):
    ...
    addressCountry = models.CharField(null=True, blank=True, max_length=1, choices=COUNTRY_CHOICES)
    addressLocality = models.CharField(null=True, blank=True, max_length=50)
    addressRegion = models.CharField(null=True, blank=True, max_length=50)
    postalCode = models.CharField(null=True, blank=True, max_length=50)
    streetAddress = models.CharField(null=True, blank=True, max_length=50)
    gender = models.CharField(null=True, blank=True, max_length=3, choices=GENDER_CHOICES)
    birthDate = models.DateField(null=True, blank=True)
    jobTitle = models.CharField(null=True, blank=True, max_length=50)
    nationality = models.CharField(null=True, blank=True, max_length=50)
    alumniOf = models.CharField(null=True, blank=True, max_length=50)
    interests = models.TextField(null=True, blank=True)
    isUpgraded = models.BooleanField(default=False)
    youtubeChannel = models.URLField(null=True, blank=True)
    timezone = models.CharField(null=True, blank=True, choices=TIMEZONE_CHOICES)

    def __unicode__(self):
        return self.user.email + u" Profile"
